...
then
    ...
    #El sed va al url y busca la línea que empieza que contiene href, extrae /ebooks/un numero que está ahí y lo que sigue y lo guarda en el archivo de titles.txt 
